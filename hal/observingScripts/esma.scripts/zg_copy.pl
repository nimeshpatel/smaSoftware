#!/usr/bin/perl -w
#
# Experiment Code: 2006-09-S054
# Experiment Title: Tracing accelerated galaxy formation in a proto-cluster at z~3.8
# PI: David Hughes
# Contact Person: Jeff Wagg  
# Email  : jwagg@aoc.nrao.edu  
# Office : 505-835-7497  
# Home   : -   
# Array  : compact   
####################  PRIMING  ####################  
...
#
# observe -s AzTEC3_4c41 -r 6:50:51.41 -d 41:30:06.4 -e 2000 -v 0
#
# dopplerTrack -r 345.796 -l -s12 
#
# setFeedOffset -f 345
#
###################   POINTING  ###################  
...
#
$inttime=30; 
$targ0="AzTEC1_4c41 -r 6:50:51.41 -d 41:30:06.4 -e 2000 -v 0";
$ntarg0=20; 
$cal0="3c111"; 
$ncal0=5; 
# after source transit, please switch to 0923 for gain cal
#$cal1="0355+508"; 
$cal1="0923+392";
$ncal1=5; 
$cal2="0642+449"; 
...
$myPID=$$;
command("project -r -p 'David Hughes' -d '2006-09-S054' -i $myPID");
