...
print "MAKE SURE YOU CHOSE A REFERENCE QUASAR/CALIBRATOR THAT WILL BE UP FOR THE ENTIRE TRACK.  WE DO NOT WANT TO SWITCH CALIBRATORS IN THE MIDDLE OF THE BASELINE TRACK\n";

$scan=7;        # How many scans
$scancal=7;        # How many scans on the calibrator quasar
$inttime=10.0;   # correlator integration time in seconds
...
GetOptions('restart','calibrator=s'=>\$calib,'help','subcompact','time','antenna=s'=>\$antList);
...
-a (antennas, the script won\'t tsys the antennas on this list)\n";
}
