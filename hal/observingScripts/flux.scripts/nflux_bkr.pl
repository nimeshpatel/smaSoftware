...
#   - All sources checked against the SMA catalog, and either 
#  typos were corrected or the sources were flagged -1 (do not observe)
#   - I relaxed the Sun distance angle ($suntar) from 50 to 40 degrees 
#  because the script was very inefficient around sunrise when it would 
#  try to observe many sources and then reject them at the last moment 
#  due to the Sun distance.
#   - I changed the minimum allowed elevation angle from 20 to 30 degrees.
###########################################################################
...
$source[50]="0423+418"; $ra[50]=+65.98337; $dec[50]=+41.83409; $priority[50]=-1;
...
$source[57]="0457-234"; $ra[57]=+74.26325; $dec[57]=-23.41445; $priority[57]=-1;
...
$source[61]="0505+049"; $ra[61]=+76.34660; $dec[61]=+4.99520; $priority[61]=-1;
...
$source[87]="0808-078"; $ra[87]=+122.06473; $dec[87]=-7.85275; $priority[87]=-1;
...
$source[186]="1751+096"; $ra[186]=+267.88675; $dec[186]=+9.65020; $priority[186]=0;
...
$source[194]="1833-210"; $ra[194]=+278.41619; $dec[194]=-21.06127; $priority[194]=0;
...
$source[199]="1911-201"; $ra[199]=+287.79022; $dec[199]=-20.11531; $priority[199]=0;
$source[200]="1924+156"; $ra[200]=+291.16440; $dec[200]=+15.67887; $priority[200]=0;
$source[201]="1924-292"; $ra[201]=+291.21273; $dec[201]=-29.24170; $priority[201]=0;
...
$source[206]="2000-178"; $ra[206]=+300.23788; $dec[206]=-17.81602; $priority[206]=0;
...
$source[227]="2158-150"; $ra[227]=+329.52617; $dec[227]=-15.01926; $priority[227]=0;
...
$source[233]="2229-085"; $ra[233]=+337.41702; $dec[233]=-8.54845; $priority[233]=0;
$source[234]="2232+117"; $ra[234]=+338.15170; $dec[234]=+11.73081; $priority[234]=0;
...
$source[241]="2323-032"; $ra[241]=+350.88314; $dec[241]=-3.28473; $priority[241]=-1;
$source[242]="2333-237"; $ra[242]=+353.48016; $dec[242]=-23.72796; $priority[242]=-1;
...
$source[248]="3c147"; $ra[248]=+85.65058; $dec[248]=+49.85201; $priority[248]=-1;
...
$source[251]="3c274"; $ra[251]=+187.70593; $dec[251]=+12.39112; $priority[251]=-1;
...
$source[254]="3c309.1"; $ra[254]=+224.78160; $dec[254]=+71.67219; $priority[254]=-1;
...
$source[258]="3c395"; $ra[258]=+285.73308; $dec[258]=+31.99492; $priority[258]=-1;
$source[259]="3c418"; $ra[259]=+309.65431; $dec[259]=+51.32018; $priority[259]=0;
$source[260]="3c446"; $ra[260]=+336.44691; $dec[260]=-4.95039; $priority[260]=0;
$source[261]="3c454.3"; $ra[261]=+343.49062; $dec[261]=+16.14821; $priority[261]=0;
$source[262]="bllac"; $ra[262]=+330.68038; $dec[262]=+42.27777; $priority[262]=0;
$source[263]="nrao530"; $ra[263]=+263.26128; $dec[263]=-13.08043; $priority[263]=0;
#$source[264]="ngc315"; $ra[264]=+14.45368; $dec[264]=+30.35245; $priority[264]=-1;
...
$nflux=40;       # Integration Time for Flux Calibrators
$ELULIMIT=84.00;  # Upper Elevation Limit of the SMA, Be careful!!!!!
$ELLLIMIT=30.0;  # Lower Elevation Limit of the SMA
...
if ($ELLLIMIT<$sourceElDegrees && $sourceElDegrees<$ELULIMIT && $sunDistance>50.0) {
    ...
    if ($calskip==1) {      # If the calibrator is too high EL ..... or too close to the Sun
        for ($i=0;$i<$num_of_tar;$i++) {
            ...
            if ($Coordtar eq '') {
                ...
                if ($ELLLIMIT<$eltar && $eltar<$ELULIMIT && $suntar>40.0) {
