...
$scan=14;        # How many scans
$scancal=14;        # How many scans on the calibrator quasar
$inttime=15.0;   # correlator integration time in seconds
$nflux=40;       # Number of scans for Flux Calibrators
