...
#Current ipoint command is 'ipoint -i 45 -r 1 -Q -s -k' for main cal and 'ipoint -i 60 -r 1 -Q -s -k'
...
$MINDate = 20091231;   #How old can the flux measurement be (i.e. yyyymmdd) 
