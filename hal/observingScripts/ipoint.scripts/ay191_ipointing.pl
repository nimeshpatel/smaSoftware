#!/usr/bin/perl -w
#
# Experiment Code: Ay191
# Experiment Title: Cyanopolynnes in IRC+10216 
# PI: Jonathan Blazek, Tim Morton
# Contact Person: Nimesh Patel 
# Office phone: 617-496-7649
# Home   phone: 617-669-5665
# Array config: compact   
####################  PRIMING  ####################  
#
# restartCorrelator -d -s 256
#
# observe -s irc+10216 -r 09:47:57.39 -d +13:16:43.9 -e 2000 -v -26.2
#
# dopplerTrack -r 218.27 -l -s12 
#
# setFeedOffset -f 230
#
###################   POINTING  ###################  
...
#
# Several ipointing runs are inserted below with RTC on/off.
#
############### SOURCE, CALIBRATOR and LIMITS ############## 
#
$inttime=30; 
$targ0="irc+10216 -r 09:47:57.39 -d +13:16:43.9 -e 2000 -v -26.2";
$ntarg0=20; 
$cal0="0854+201"; 
$ncal0=4; 
$cal1="1058+015"; 
...
command("tol -a 1..6 -c on");
$myPID=$$;
command("project -r -p 'AY191 students Blazek and Morton' -d 'Ay191 and SMA RTC pointing tests' -i $myPID");
...
sub iPointing {
	   $pntSource=shift;
                    command("observe -s $pntSource");
		    command("point -i 90 -r 1 -L -l -t -Q");
}
