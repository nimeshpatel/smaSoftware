...
#Current ipoint command is 'ipoint -i 45 -r 1 -Q -s -k' for main cal and 'ipoint -i 45 -r 1 -Q -s -k'
...
$MINFlux = 1.0;  #How bright do you need the pointing sources(in Jy)?
$MINDate = 20100101;   #How old can the flux measurement be (i.e. yyyymmdd) 
