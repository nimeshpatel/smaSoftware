 ...
 *  modified by TK 10May 2010 - include total power data (not complete)
  lynxos
...
/*                        for (i_delay=1; i_delay<n_delay; i_delay++){} */
                        for (i_delay=1; i_delay<n_delay; i_delay++){GetPosTime();}
...
/* read total power value 10 May 2010 TK*/
...
/* */
	printf("%8.4f %7.4f %4d %6.2f %6.2f %6.2f %6.2f %7.1f %7.1f %7.1f %7.1f %d %d %6.4f\n",az_av,el_av,l,chop_x_av,chop_y_av,chop_z_av,chop_angle_av,amp_av,pha_av,amp2_av,pha2_av, day, msec, contDet_a1[0]);
		fprintf(fp,"%8.4f %7.4f %4d %6.2f %6.2f %6.2f %6.2f %7.1f %7.1f %7.1f %7.1f %d %d %6.4f\n",az_av,el_av,l,chop_x_av,chop_y_av,chop_z_av,chop_angle_av,amp_av,pha_av,amp2_av,pha2_av, day, msec, contDet_a1[0]);
/*	printf("Day %d, msec %d\n", day, msec); */
	}
