...
#
#
# What is the exact rest frequency of your line? 279.512
#
# Which sideband do you wish to put your line in?    LSB
#
...
#
# correlator setup:
# hal9000> restartCorrelator -d -s 7:512 -s 14:512 -s 128
# 
# Doppler tracking:
#  hal9000> standby
#  hal9000> observe -s hmsc1 -r 18:41:17.3 -d -05:10:04 -e 2000 -v 46.0
#  hal9000> dopplerTrack -r 279.512 -l -s 14
#
...
#
#
$cal1="1741-038";  $ncal1= 8; # primary calibrator;  number of scans
