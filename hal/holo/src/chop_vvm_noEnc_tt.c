...
int main(int argc, char **argv)
{
   ...
   /* union       ad_union amp_vvm[10], pha_vvm[10]; */
	...
	float Az[10000], El[10000], Amp[10000], Pha[10000];
 	float Chop_angle[10000],Chop_x[10000],Chop_y[10000],Chop_z[10000];
...
/*  instead of above, delay using GetPosTime() from ttsubs.c- using interrupts from
TrueTime */
	GetPosTime();
...
/*		printf("%8.4f %7.4f %4d %6.2f %6.2f %6.2f %5d %5d\n",az_enc,el_enc,l,chop_x_av,chop_y_av,chop_z_av,amp,pha);*/
		...
		Az[l] = az_av;
		El[l] = el_av;
		Amp[l]=amp_sum/num_of_ave;
		Pha[l]=pha_sum/num_of_ave;
    		Chop_angle[l]=num_of_ave;
		Chop_x[l]=num_of_ave;
		Chop_y[l]=num_of_ave;
		Chop_z[l]=num_of_ave;
		Msec[l]=msec;

/*		printf("%8.4f %7.4f %4d %6.2f %6.2f %6.2f %6.2f %7.1f %7.1f %d\n",az_av,el_av,l,chop_x_av,chop_y_av,chop_z_av,chop_angle_av,amp_av,pha_av, msec);
		fprintf(fp,"%8.4f %7.4f %4d %6.2f %6.2f %6.2f %6.2f %7.1f %7.1f %d\n",az_av,el_av,l,chop_x_av,chop_y_av,chop_z_av,chop_angle_av,amp_av,pha_av, msec); */
/* write output file at the end */
	}
for(k=1;k<l;k++){
		fprintf(fp,"%8.4f %7.4f %4d %6.2f %6.2f %6.2f %6.2f %7.1f %7.1f %d\n",Az[k],El[k],k,Chop_x[k],Chop_y[k],Chop_z[k],Chop_angle[k],Amp[k],Pha[k], Msec[k]); 
	fflush(fp);
                }
