...
#	printf OUT "%02d:%02d:%02d %5.2f %5.2f %5.2f %5.2f %5.2f %5.2f %5.2f %5.2f %5.2f %5.2f\n",$hour,$min,$sec,$te,$tamb2,$tx2,$ty2,$tamb3,$tx3,$ty3,$tamb4,$tx4,$ty4;
	printf "%02d:%02d:%02d %5.2f %5.2f %5.2f %5.2f\n",$hour,$min,$sec,$te,$tamb4,$tx4,$ty4;
	printf OUT "%02d:%02d:%02d %5.2f %5.2f %5.2f %5.2f\n",$hour,$min,$sec,$te,$tamb4,$tx4,$ty4;
#	select(undef,undef,undef,0.2); #wait 0.2 sec
}
