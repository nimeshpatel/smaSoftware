...
void usage(int exitcode, char *error, char *addl) {
        ...
        fprintf(stderr, "Usage: startChoppingSpect [options] \n"
                "[options] include:\n"
                "  -h or --help    this help\n"
...
void main(int argc, char *argv[])  
{
	...
	short antenna,pmac_command_flag=0;
	...
	smapoptContext optCon;
	 ...
	 struct  smapoptOption optionsTable[] = {
        ...
        optCon = smapoptGetContext("startChoppingSpect", argc, argv, optionsTable,0);
