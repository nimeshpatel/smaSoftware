...
* NAP 20 Feb 2001 revised Y position for antenna-3
* 	following Masao's measurements.
...
*
* Revised on 23 Aug 01 to read a file called nearChopper.dat from
...
void usage(int exitcode, char *error, char *addl) {
        ...
        fprintf(stderr, "Usage: nearChopper [options] \n"
                "[options] include:\n"
                "  -h or --help    this help\n"
...
void main(int argc, char *argv[])  
{
	...
	short antennaStatus = 0;
	 ...
	 struct  smapoptOption optionsTable[] = {
        ...
        optCon = smapoptGetContext("nearChopper", argc, argv, optionsTable,0);
	...
	for(iant=1;iant<=8;iant++) {
        ...
        sprintf(pmaccommand,"chopperCommand2 -a %d -c nearChopper",antenna);
        system(pmaccommand);
