...
* NAP 27 feb 2001 revised for default operation in all antennas
...
void usage(int exitcode, char *error, char *addl) {
        ...
        fprintf(stderr, "Usage: resume [options] \n"
                "[options] include:\n"
                "  -h or --help    this help\n"
...
/*      char messg[100]; */
	...
	int numberOfAnts=0;
	 ...
	 struct  smapoptOption optionsTable[] = {
        ...
        optCon = smapoptGetContext("resume", argc, argv, optionsTable,0);
