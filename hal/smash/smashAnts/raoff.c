...
* 
* NAP 18 SEP 2002.
* NAP 23 Feb 2004. Changed antennas to SMAPOPT_ARG_ANTENNAS instead of INTS. 
* NAP 16 Jan 2007. Added a flag for changing source name (appending
* 			a string to the source name)..
*
****************************************************************/
...
void usage(int exitcode, char *error, char *addl) {
        ...
        fprintf(stderr, "Usage: raoff [options] --arcseconds (or -s) <arcseconds>\n"
                "[options] include:\n"
                "  -h or --help    this help\n"
...
raoff(arcseconds) required.");
	...
	for(i=0;i<30;i++) {
	 ...
	 if(gotraoff!=1) usage(-2,"No offset specified","Az (arcseconds) is 
	required .\n");
