...
* NAP 27 Feb 2001 revised to command all antennas by default 
...
void usage(int exitcode, char *error, char *addl) {
        ...
        fprintf(stderr, "Usage: azscan [options] \n"
                "[options] include:\n"
                "  -h or --help    this help\n"
...
/*      char messg[100]; */
	...
	int numberOfAnts=0;
	 ...
	 struct  smapoptOption optionsTable[] = {
        ...
        optCon = smapoptGetContext("azscan", argc, argv, optionsTable,0);
	...
	command_n[0]='a'; /* send the command */
