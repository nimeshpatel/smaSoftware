...
* Revisded on 27 Feb 2001 to command all antennas on default.
...
void usage(int exitcode, char *error, char *addl) {
        ...
        fprintf(stderr, "Usage: el [options] \n"
	 " -d <degrees> or\n"
	 " --degrees <degrees>.\n"
                "[options] include:\n"
                "  -h or --help    this help\n"
...
/*      char messg[100]; */
	...
	int gotel=0,rm_status,antlist[RM_ARRAY_SIZE];
	float el,actual_az,actual_el;
...
.\n");
	...
	rm_status=rm_write(antenna, "RM_SMARTS_AZ_DEG_F",&actual_az);
