...
* RTM 22 Feb 2011. Changed ELSTOW to 35 for subcompact.
****************************************************************/
...
printf("********************************************************************************\n");
printf("********************************************************************************\n");
printf("Please make sure that all antennas have actually reached the stow
position before issuing any further commands, or leaving the array
unattended.\n");
printf("********************************************************************************\n");
printf("********************************************************************************\n");
}
