...
void usage(int exitcode, char *error, char *addl) {
        ...
        fprintf(stderr, "Usage: pmacCommand [options] -c <pmacCommand string>\n"
                "[options] include:\n"
                "  -h or --help    this help\n"
...
void main(int argc, char *argv[])  
{
	...
	char c,messg[100],*command_n,command_n_copy[30];
	...
	int  antenna;
	 ...
	 struct  smapoptOption optionsTable[] = {
                ...
                {"command",'c',SMAPOPT_ARG_STRING,&command_n,'c'},
                {NULL,0,0,NULL,0}
        };
...
a command to the PMAC is required.");
 
        optCon = smapoptGetContext("pmacCommand", argc, argv, optionsTable,0);
 ...
 if(gotc!=1) usage(-2,"No command specified","A pmac Command expected.\n");
	...
	strcpy(command_n_copy,command_n);

printf("command: %s\n",command_n_copy);
printf("given to antenna: %d\n",antenna);
