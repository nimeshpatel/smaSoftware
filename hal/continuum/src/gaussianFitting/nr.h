...
typedef struct FCOMPLEX {float r,i;} fcomplex;
	...
	void fgauss2(float, float *, float *, float *, int);
	...
	void  des(immense inp, immense key, int *newkey, int isw,
					immense *out);
	...
	void  mrqcof(double *x, double *y, double *sig, int ndata, double *a, int ma, 
					int *lista, int mfit, double **alpha, double *beta, double *chisq, void (*funcs)(double,double *,double *,double *,int));
