 ...
 * $Id: tsshm.h,v 1.14 2014/06/19 19:36:51 rwilson Exp $
 * $Log: tsshm.h,v $
 * Revision 1.14  2014/06/19 19:36:51  rwilson
...
typedef struct {
	...
	int tach1AzVel;		/* Tach 1 voltage cvt to Az axis vel (mas/s) */
	int tach2AzVel;		/* Tach 1 voltage cvt to Az axis vel (mas/s) */
	float mot1CurrentAz;	/* Current(A) in Az motor 1 from Glentek */
	float mot2CurrentAz;	/* Current(A) in Az motor 2 from Glentek */
	...
	float motCurrentEl;	/* Current(A) in El motor */
