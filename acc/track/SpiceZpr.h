...
*/
   ...
   void              conics_c ( SpiceDouble         elts[8],
                                SpiceDouble         et,
                                SpiceDouble         state[6] );
   ...
   void              spkuds_c ( SpiceDouble         descr [5],
                                SpiceInt          * body,
                                SpiceInt          * center,
                                SpiceInt          * frame,
                                SpiceInt          * type,
