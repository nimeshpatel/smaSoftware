/****************************************************************
 This file is gltrack.c

        Nimesh Patel
	
	12 March 2012: copied from track.c

	This version is for the Greenland Telescope.
	
	All RM communications are replaced by DSM.
